...
生成物：cases/ 全量 JSONL、batches/ 分批清单（每批 10 例）、hard_gates.json 术语表、pack_manifest.yaml。
...
CASE_FIELDS = (
    ...
    "founder_review_coverage", "sampling_allowed",
)


def build_cases() -> list[dict]:
    cases = yaml.safe_load(CAL.read_text(encoding="utf-8"))["cases"]
    return [{k: case[k] for k in CASE_FIELDS if k in case} for case in cases]
...
HANDWRITTEN = (
    "README_分发说明.md",
    "review_prompt.shared.v1.0.0.md",
    "output_format.md",
    "identity_lines.yaml",
)
...
def build_manifest(generated: dict[str, str]) -> str:
    ...
    doc = {
        ...
        "review_prompt": {
            "path": "review_prompt.shared.v1.0.0.md",
            "sha256": sha256((PACK / "review_prompt.shared.v1.0.0.md").read_text(encoding="utf-8")),
            "shared_by_both_sides": True,
            "only_identity_line_differs": True,
        },
        "must_not_contain": {
            "kinds": ["项目治理上下文", "既往结论", "其他评审结果"],
        ...
        "failure_states": [
            ...
            "PACK_PROMPT_HASH_MISMATCH", "PACK_FILE_MISSING",
        ],
    }
